...
private:
  ...
  set<string> visited;
  //unvisit all items in map
  void unVisitNeighbor();
  //dfs helper for dfs function
  void DFSHelper(const string &StartLabel, void Visit(const string &Label));
  //minimum time span tree helper
  int mstHelper(const string &StartLabel,
                void Visit(const string &From, const string &To,
                           int Weight), map<string, bool> &Check) const;
};
